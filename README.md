...
# Uploaded images (must be made public)
...
# Temp/in-progress uploads (kept private)
...
# Finished uploads (must be made public)
...
You will need an few S3 buckets to store temp file uploads, hosted file uploads, and images. You can use [Cloudflare R2](https://r2.cloudflare.com/) (suggested) or [AWS S3](https://aws.amazon.com/s3/) for this. You can keep the temp file uploads bucket private, as the app will handle file access through signed URLs. The other two must be public with a base url set up to access them.
...
[
	{
		"AllowedOrigins": ["http://localhost:5173", "https://astroconnect.org"],
